...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.isProductInstalled('collective.collectiongathering'))
    ...
    def test_uninstall(self):
        ...
        self.assertFalse(self.installer.isProductInstalled('collective.collectiongathering'))

    def test_browserlayer(self):
        """Test that ICollectiveCollectiongatheringLayer is registered."""
        from collective.collectiongathering.interfaces import ICollectiveCollectiongatheringLayer
